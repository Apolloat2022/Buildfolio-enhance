...
export default function GlobalAIHelper() {
  ...
  if (!isOpen) {
    return (
      <button onClick={() => setIsOpen(true)} className="fixed bottom-24 right-8 z-40 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full shadow-lg hover:from-blue-700 hover:to-purple-700 font-semibold">
        🤖 Ask AI
      </button>
    )
  }
